...
$(document).ready(function(){
	...
	$('#addButton').click(function(e){
		...
		msg='<li id="todo-'+count+'" class="todo"><div class="text">New Todo Item. Doubleclick to Edit</div><div class="actions"><a href="#" class="edit">Edit</a><a href="#" class="delete">Delete</a></div></li>';
